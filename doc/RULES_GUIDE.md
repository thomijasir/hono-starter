...
- Use `Result` type from `~/utils` for all functions that can fail.
- Use `errorResponse` helper for consistent error responses.

## 7. Naming Conventions

Please refer to [CONVENTION_GUIDE.md](CONVENTION_GUIDE.md) on how to name files, folders, and variables.
